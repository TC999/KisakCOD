...
struct scr_const_t
{
    ...
    unsigned __int16 grenade_return_hand_tag;
    unsigned __int16 groundEntChanged;
    unsigned __int16 gunshot;
    unsigned __int16 high_priority;
    unsigned __int16 info_player_deathmatch;
    unsigned __int16 infinite_energy;
    unsigned __int16 low_priority;
    unsigned __int16 obstacle;
    unsigned __int16 manual;
    unsigned __int16 manual_ai;
    unsigned __int16 max_time;
    unsigned __int16 menuresponse;
    unsigned __int16 middle_left;
    unsigned __int16 middle_right;
    unsigned __int16 min_energy;
    unsigned __int16 min_time;
    unsigned __int16 movemode;
    unsigned __int16 neutral;
    unsigned __int16 never;
